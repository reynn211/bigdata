...
def get_spark():
    return (
        ...
        .appName("ETL_StarSchema_to_ClickHouse")
...
def write_to_ch(df, table_name):
    ...
    (df.write
     ...
     .mode("overwrite")
     .save())
    print(f"  -> {table_name}: written to ClickHouse")
...
def main():
    ...
    sales_product = (
        fact_sales
        .join(product_full, "product_id", "left")
    )
    ...
    write_to_ch(report_product_sales, "report_product_sales")
    ...
    write_to_ch(report_customer_sales, "report_customer_sales")
    ...
    write_to_ch(report_time_sales, "report_time_sales")
    ...
    write_to_ch(report_store_sales, "report_store_sales")
    ...
    write_to_ch(report_supplier_sales, "report_supplier_sales")
    ...
    write_to_ch(report_product_quality, "report_product_quality")
