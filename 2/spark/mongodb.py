...
def get_spark():
    return (
        ...
        .appName("ETL_StarSchema_to_MongoDB")
...
def write_to_mongo(df, collection_name):
    ...
    (df.write
     ...
     .mode("overwrite")
     .save())
    print(f"  -> {collection_name}: written to MongoDB")
...
def main():
    ...
    write_to_mongo(report_product_sales, "report_product_sales")
    ...
    write_to_mongo(report_customer_sales, "report_customer_sales")
    ...
    write_to_mongo(report_time_sales, "report_time_sales")
    ...
    write_to_mongo(report_store_sales, "report_store_sales")
    ...
    write_to_mongo(report_supplier_sales, "report_supplier_sales")
    ...
    write_to_mongo(report_product_quality, "report_product_quality")
